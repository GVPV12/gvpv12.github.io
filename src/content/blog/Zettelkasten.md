---
title: Zettelkasten en Obsidian. Aka Segundo Cerebro
description: ¿Que es Zettelkasten? También llamado segundo cerebro o second brain
pubDate: 2026-02-09
tags:
  - Obsidian
  - Jardin-digital
...
Se traduce literalmente como **"caja de notas"** (_Zettel_ = nota/papeleta, _Kasten_ = caja).
...
- **P.A.R.A.:** El sistema de organización de Tiago Forte. Son las siglas de:
    ...
    - **P**royectos (cosas con fecha límite).
        
    - **A**reas (responsabilidades continuas, como "Salud" o "Finanzas").
        
    - **R**ecursos (temas que te interesan pero no tienen urgencia).
        
    - **A**rchivos (cosas terminadas).
...
|**Término**|**Qué es**|
|---|---|
|**Atomic Notes**|Notas que contienen una sola idea. Si intentas meter dos temas en una, ¡divídela!|
|**Fleeting Notes**|Notas rápidas ("sucias") que tomas mientras vas en el bus o escuchas un podcast.|
|**Literature Notes**|Notas sobre lo que alguien más dijo (un libro, un video).|
|**Permanent Notes**|Tus propias ideas, ya procesadas y redactadas para tu "yo" del futuro.|
...
1. **C**apture (Capturar): Guardar lo que te resuena.
    
2. **O**rganize (Organizar): Ponerlo en su sitio (usando PARA).
    
3. **D**istill (Destilar): Encontrar la esencia (usando _Resaltado Progresivo_).
    
4. **E**xpress (Expresar): Crear algo nuevo con esa información.
